...
def normalize_git_local_config(value: Any) -> Dict[str, Any]:
    """Validate and normalize metadata for an uploaded local Git snapshot."""
    ...
    async def access(self, source: Union[str, Path], **kwargs) -> LocalResource:
        ...
        try:
            ...
            return LocalResource(
                ...
                original_source=(
                    git_local["repo_key"] if git_local else source_str
                ),  # Full URL or stable local repository identity.
                meta=meta,
                is_temporary=True,
            )
